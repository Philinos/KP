...
/****** Object:  Database [Anket]    Script Date: 01.02.2021 12:32:21 ******/
CREATE DATABASE [Anket]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'Anket', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL14.SQLEXPRESS01\MSSQL\DATA\Anket.mdf' , SIZE = 8192KB , MAXSIZE = UNLIMITED, FILEGROWTH = 65536KB )
 LOG ON 
( NAME = N'Anket_log', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL14.SQLEXPRESS01\MSSQL\DATA\Anket_log.ldf' , SIZE = 8192KB , MAXSIZE = 2048GB , FILEGROWTH = 65536KB )
GO
...
ALTER DATABASE [Anket] SET RECOVERY SIMPLE 
GO
...
ALTER DATABASE [Anket] SET FILESTREAM( NON_TRANSACTED_ACCESS = OFF ) 
GO

ALTER DATABASE [Anket] SET TARGET_RECOVERY_TIME = 60 SECONDS 
GO

ALTER DATABASE [Anket] SET DELAYED_DURABILITY = DISABLED 
GO

ALTER DATABASE [Anket] SET QUERY_STORE = OFF
GO
